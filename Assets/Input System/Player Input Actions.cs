...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IHelpMenuActions> m_HelpMenuActionsCallbackInterfaces = new List<IHelpMenuActions>();
    ...
    public struct HelpMenuActions
    {
        ...
        public void AddCallbacks(IHelpMenuActions instance)
        {
            if (instance == null || m_Wrapper.m_HelpMenuActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_HelpMenuActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IHelpMenuActions instance)
        {
            @NextPage.started -= instance.OnNextPage;
            @NextPage.performed -= instance.OnNextPage;
            @NextPage.canceled -= instance.OnNextPage;
        ...
        public void RemoveCallbacks(IHelpMenuActions instance)
        {
            if (m_Wrapper.m_HelpMenuActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IHelpMenuActions instance)
        {
            foreach (var item in m_Wrapper.m_HelpMenuActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_HelpMenuActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
